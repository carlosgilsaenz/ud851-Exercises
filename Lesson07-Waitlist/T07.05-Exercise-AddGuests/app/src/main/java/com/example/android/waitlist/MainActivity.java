...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        String partyName = mNewGuestNameEditText.getText().toString().trim();
        String partySize = mNewPartySizeEditText.getText().toString().trim();
        if(partyName.equals("") || partyName.isEmpty() || partySize.equals("") || partySize.isEmpty()){return;}
        ...
        try{
            partyCount = Integer.parseInt(partySize);
        }catch (Exception e){
            Log.e(LOG_TAG,"" + e);
        }

        // complete (14) call addNewGuest with the guest name and party size
        addGuest(partyName, partyCount);
