...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String JSON_KEY = "JSON_RAW";
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        String stringURL = mUrlDisplayTextView.getText().toString().trim();
        outState.putString(URL_KEY,stringURL);

        String stringResults = mSearchResultsTextView.getText().toString().trim();
        outState.putString(JSON_KEY,stringResults);
    }
