...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        long totalUntilBoarding = info.getMinutesUntilBoarding();
        long hoursUntilBoarding = TimeUnit.MINUTES.toHours(totalUntilBoarding);
        long minsUntilBoarding = totalUntilBoarding - TimeUnit.HOURS.toMinutes(hoursUntilBoarding);

        String untilBoarding = hoursUntilBoarding + ":" + minsUntilBoarding;
        mBinding.textViewBoardingInCountdown.setText(untilBoarding);
    }
}
