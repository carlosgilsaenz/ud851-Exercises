...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String LIFECYCLE_CALLBACKS_TEXT_KEY  = "callback_key";
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        String s = mLifecycleDisplay.getText().toString().trim();
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY ,s);
    }
