...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if(Build.VERSION.SDK_INT < Build.VERSION_CODES.M){
            ...
            int extra = batteryStatus.getIntExtra(BatteryManager.EXTRA_STATUS, -1);
            isCharging = extra == BatteryManager.BATTERY_STATUS_CHARGING ||
                    extra == BatteryManager.BATTERY_STATUS_FULL;
