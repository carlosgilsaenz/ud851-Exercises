...
public class NotificationUtils {
    ...
    private static final int ID_PENDING_INTENT = 333;
    private static final int ID_REMINDER_USER = 444;
    ...
    public static void remindUserBecauseCharging(Context context){
        ...
        nManager.notify(ID_REMINDER_USER, notificationBuild.build());
    }
    ...
    private static PendingIntent contentIntent(Context context){
        ...
        return PendingIntent.getActivity(context, ID_PENDING_INTENT, mainIntent,PendingIntent.FLAG_UPDATE_CURRENT);
    }
    ...
    private static Bitmap largeIcon(Context context){
        ...
        Resources resourceObject = context.getResources();
        // TODO (6) Create and return a bitmap using BitmapFactory.decodeResource, passing in the
        // resources object and R.drawable.ic_local_drink_black_24px
        return BitmapFactory.decodeResource(resourceObject, R.drawable.ic_local_drink_black_24px);
    }
}
